...
if __name__ == '__main__':
    ...
    create_jsub(output_name='submission_files/{}.jsub'.format(args.project_name), 
                ...
                other_files=['/u/home/dmriser/clas/retro-sidis/farm/config.json', 
                             '/u/home/dmriser/clas/retro-sidis/farm/run_all.py'], 
                output_data=None, 
                output_template=None, 
                input_files=input_files)
    
    os.system('jsub submission_files/{}.jsub'.format(args.project_name))
