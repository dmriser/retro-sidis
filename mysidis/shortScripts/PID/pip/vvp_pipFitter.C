void vvp_pipFitter(int sector = 1)
{
  ...
  TFile *file[Ntypes];
  file[0] = new TFile("/u/home/dmriser/mysidis-histos/pid.MonteCarlo_v12.s1.n32255.root");
  file[1] = new TFile("/u/home/dmriser/mysidis-histos/pid.data.s1.n12114.root");
