...
void systematics_v2(int xBin = 0, int QQBin = 0, int zBin = 3, 
  ...
  string baseDirectory("/volatile/clas12/dmriser/farm_out"); 
  string projectName("sidis_batch_11"); 
  string pathToRequiredFiles("/u/home/dmriser/clas/retro-sidis/mysidis/requiredFiles"); 
  ...
  tfdata[7][0] = new TFile("/home/harrison/mysidis-histos/data.s1.n11625.BiSc5.MoCo11.__00000000-10000000__.root"); 
